...
public class Array2Example {
	...
	public void ex1() {
		...
		*/
		...
		System.out.println("toString() : " + Arrays.toString(arr));   // toString() : [[I@626b2d4a, [I@5e91993f]
	...
	public void ex2() {
		...
		// 2차원 배열 선언과 동시에 초기화
		// 3행 열짜리 정수형 2차원 배열 선언과 동시에
		// 1~9까지 초기화
		int[][] arr = { {1,2,3}, {4,5,6}, {7,8,9} };
		
	//	int[][] arr = { {1,2,3},    // 0행
	//					{4,5,6}, 
	//					{7,8,9} };  // 이렇게 표기하면 알기 쉬움.
		...
		// 행 별로 합출력은 같은행의 각 열이 합해진 것이었고,
		// 열 별로 합출력은 같은열의 각 행이 합해지는 것.
		
		for(int col = 0; col<arr[0].length; col++ ) { // 같은 값이므로 arr[0].length 이든 arr[1].length 이든 arr[2].length이든 상관x
